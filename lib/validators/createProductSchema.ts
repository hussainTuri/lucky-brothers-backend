...
export const createProductSchema = Joi.object({
  ...
  imagePath: Joi.string().max(255).allow(null).optional(),
  size: Joi.string().max(255).allow(null).optional(),
  diameter: Joi.number().integer().allow(null).optional(),
  speedIndex: Joi.string().max(255).allow(null).optional(),
  loadIndex: Joi.string().max(255).allow(null).optional(),
  season: Joi.string().max(255).allow(null).optional(),
  ...
  design: Joi.string().max(255).allow(null).optional(),
  threadSize: Joi.string().max(255).allow(null).optional(),
