...
import { getTransportCustomerTransactions as getTransportCustomerTransactionsRepository } from '../../../../prisma/repositories/transport/customers/transactions';
...
export const getTransactions = async (req: Request, res: Response) => {
  ...
  try {
    resp.data = await getTransportCustomerTransactionsRepository(
