...
import { getVehicleTransactions as getVehicleTransactionsRepository } from '../../../../prisma/repositories/transport/vehicles/transactions';
...
export const getTransactions = async (req: Request, res: Response) => {
  ...
  try {
    resp.data = await getVehicleTransactionsRepository(Number(req.params.vehicleId), filters, sort);
  } catch (error) {
